  ...
  return {
    ...
    async *partialEmit(ctx, _content, _resources, changeEvents) {
      ...
      for (const changeEvent of changeEvents) {
        ...
        // Skip files that live under an ignored path (e.g. Google Drive tmp dirs).
        const segments = changeEvent.path.split("/")
        if (ignorePatterns.some((pat) => segments.includes(pat))) continue
